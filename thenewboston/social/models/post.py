    ...
    def extract_and_save_mentions(self):
        ...
        if mentioned_users:
            ...
            create_mention_notifications(
                mentioned_users=mentioned_users, mentioner=self.owner, content_type='post', content_id=self.id
            )


@receiver(post_save, sender=Post)
def handle_post_mentions(sender, instance, created, **kwargs):
    """Extract and process mentions when a post is created."""
    if created:
